...
stdenvNoCC.mkDerivation {
  ...
  installPhase = ''
    ...
    cp jev-router.mjs policy.mjs facts.mjs check.mjs loop-stop.mjs permission.mjs catalog.mjs package.json $out/lib/jev-router/
  ...
  meta = {
    description = "Router-only Jev Choice gate, shadow permission catalogs, and tiny tool catalog (runtime key)";
